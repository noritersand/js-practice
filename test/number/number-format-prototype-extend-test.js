...
console.log('format():')
console.log('- 1234:', (1234).format());           // "1,234"
console.log('- 1234:', (1234.).format());           // "1,234"
console.log('- 12345:', (12345.).format(2));         // "12,345.00"
console.log('- 123456.7:', (123456.7).format(3, 2));    // "12,34,56.700"
console.log('- 123456.789:', (123456.789).format(2, 4));  // "12,3456.79"
console.log('\n');
...
console.log('format2():')
console.log('- format2():', (123456).format2(0)); // "123,456"
console.log('- format2():', (123456).format2(2)); // "123,456.00"
console.log('- format2():', (123456.789).format2(4)); // 123,456.7890
console.log('- format2():', (123456).format2(2, '|')); // "123,456|00"
console.log('- format2():', (123456).format2(2, null, '|')); // "123|456.00"
console.log('\n');
...
console.log('format3():')
console.log('- 12345678.9:', (12345678.9).format3(2, 3, '.', ','));  // "12.345.678,90"
console.log('- 123456.789:', (123456.789).format3(4, 4, ' ', ':'));  // "12 3456:7890"
console.log('- 12345678.9:', (12345678.9).format3(0, 3, '-'));       // "12-345-679"
console.log('\n');
