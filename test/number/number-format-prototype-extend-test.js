...
log('format():')
log('- 1234:', (1234).format());           // "1,234"
log('- 1234:', (1234.).format());           // "1,234"
log('- 12345:', (12345.).format(2));         // "12,345.00"
log('- 123456.7:', (123456.7).format(3, 2));    // "12,34,56.700"
log('- 123456.789:', (123456.789).format(2, 4));  // "12,3456.79"
log('\n');
...
log('format2():')
log('- format2():', (123456).format2(0)); // "123,456"
log('- format2():', (123456).format2(2)); // "123,456.00"
log('- format2():', (123456.789).format2(4)); // 123,456.7890
log('- format2():', (123456).format2(2, '|')); // "123,456|00"
log('- format2():', (123456).format2(2, null, '|')); // "123|456.00"
log('\n');
...
log('format3():')
log('- 12345678.9:', (12345678.9).format3(2, 3, '.', ','));  // "12.345.678,90"
log('- 123456.789:', (123456.789).format3(4, 4, ' ', ':'));  // "12 3456:7890"
log('- 12345678.9:', (12345678.9).format3(0, 3, '-'));       // "12-345-679"
log('\n');
