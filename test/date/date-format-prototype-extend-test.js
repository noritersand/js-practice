...
var now = new Date();
console.log('now.format(\'yyyy-MM-dd HH:mm:ss\'):', now.format('yyyy-MM-dd HH:mm:ss')); // 2019-03-28 12:12:12
console.log('now.format(\'yyMMdd\'):', now.format('yyMMdd')); // 190328
console.log('now.format(\'a/p hh시 mm분\'):', now.format('a/p hh시 mm분')); // 오후 03시 28분
console.log('now.format(\'MM월 dd일 E\'):', now.format('MM월 dd일 E')); // 03월 28일 목요일 
console.log('now.format(\'HH:mm:ss.sss\'):', now.format('HH:mm:ss.sss')); // 2019-03-28 12:12:12.854
